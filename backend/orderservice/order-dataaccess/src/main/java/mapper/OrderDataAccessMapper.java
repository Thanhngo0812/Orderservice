...
public class OrderDataAccessMapper {
    ...
    private OrderStatus mapOrderStatus(valueobject.OrderStatus orderStatus) {
        if (orderStatus == null) {
            return null;
        }
    ...
    private valueobject.OrderStatus mapOrderStatus(OrderStatus orderStatus) {
        if (orderStatus == null) {
            return null;
        }
        return valueobject.OrderStatus.valueOf(orderStatus.name());
    }
}